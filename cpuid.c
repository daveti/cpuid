                  ...
                  const code_stash_t*  stash)
{
   ...
   FMSQ(    0, 6,  3, 7,  8, dP, "Intel Pentium N3500 (Bay Trail-M C0), 22nm");
   FMS (    0, 6,  3, 7,  8,     "Intel Pentium N3500 / Celeron N2800 / N2900 (Bay Trail-M C0) / Atom Z3000 (Bay Trail-T B2/B3), 22nm");
   ...
   FM  (    0, 6,  8,14,         "Intel m3-7Y00 / i5-7Y00 / i7-7Y00 / i3-7000U / i5-7000U / i7-7000U (Kaby Lake), 14nm");
   FM  (    0, 6,  9,14,         "Intel Core (Kaby Lake), 14nm"); // no spec update; only 325462 Volume 3 Table 35-1 so far
...
{
   static named_item  names[]
      = { { "ways of associativity"                   ,  0, 31, NIL_IMAGES },
        };
...
print_7_ebx(unsigned int  value)
{
   static named_item  names[]
      = { { "FSGSBASE instructions"                   ,  0,  0, bools },
          ...
          { "QM: quality of service monitoring"       , 12, 12, bools },
...
{
   static named_item  names[]
      = { { "IA32_RTIT_CTL can enable tracing"        ,  0,  0, bools },
          { "ToPA can hold many output entries"       ,  1,  1, bools },
          { "single-range output scheme"              ,  2,  2, bools },
